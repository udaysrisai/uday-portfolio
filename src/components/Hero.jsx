        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
              <button className="btn-teal" onClick={onViewResume} style={{ display: "inline-flex", alignItems: "center", gap: 8, border: "none", cursor: "pointer" }}>
                <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
                View Resume
              </button>
              <a href="/Uday_Resume.pdf" download="Uday_Sri_Sai_Resume.pdf" className="btn-outline">
